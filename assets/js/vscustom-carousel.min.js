! function (e) {
    ...
    e(".vs-carousel").each((function () {
        ...
        e("[data-slick-next]").each((function () {
            ...
            vertical: !!t("vertical"),
            prevArrow: t("prev-arrow") ? o : '<button type="button" class="slick-prev"><i class="far fa-chevron-left"></i></button>',
            nextArrow: t("next-arrow") ? r : '<button type="button" class="slick-next"><i class="far fa-chevron-right"></i></button>',
            rtl: "rtl" == e("html").attr("dir"),
            rows: t("rows") ? t("rows") : 1,
            responsive: [{
                breakpoint: 1600,
                settings: {
                    arrows: !!t("xl-arrows"),
                ...
                settings: {
                    arrows: !!t("xs-arrows"),
                    dots: !!t("xs-dots"),
                    slidesToShow: t("xs-slide-show") ? t("xs-slide-show") : 2,
