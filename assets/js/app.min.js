...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push((function () {
    ...
    function h(e, t, i, n, a) {
      var l, c, d, u, h, f, m, g, v, y, b, _, w, x = e.length - 1,
        k = 0,
        T = e[0].a;
      for (l = 0; l < x; l++) c = (h = e[k]).a, d = h.d, u = e[k + 1].d, g = a ? (b = o[l], w = ((_ = s[l]) + b) * t * .25 / (n ? .5 : r[l] || .5), d - ((f = d - (d - c) * (n ? .5 * t : 0 !== b ? w / b : 0)) + (((m = d + (u - d) * (n ? .5 * t : 0 !== _ ? w / _ : 0)) - f) * (3 * b / (b + _) + .5) / 4 || 0))) : d - ((f = d - (d - c) * t * .5) + (m = d + (u - d) * t * .5)) / 2, f += g, m += g, h.c = v = f, h.b = 0 !== l ? T : T = h.a + .6 * (h.c - h.a), h.da = d - c, h.ca = v - c, h.ba = T - c, i ? (y = p(c, T, v, d), e.splice(k, 1, y[0], y[1], y[2], y[3]), k += 4) : k++, T = m;
      (h = e[k]).b = T, h.c = T + .4 * (h.d - T), h.da = h.d - h.a, h.ca = h.c - h.a, h.ba = T - h.a, i && (y = p(h.a, T, h.c, h.d), e.splice(k, 1, y[0], y[1], y[2], y[3]))
    }

    function f(e, t, i, n) {
      var r, a, l, c, d, p, h = [];
      if (n)
        for (a = (e = [n].concat(e)).length; - 1 < --a;) "string" == typeof (p = e[a][t]) && "=" === p.charAt(1) && (e[a][t] = n[t] + Number(p.charAt(0) + p.substr(2)));
      if ((r = e.length - 2) < 0) return h[0] = new u(e[0][t], 0, 0, e[0][t]), h;
      for (a = 0; a < r; a++) l = e[a][t], c = e[a + 1][t], h[a] = new u(l, 0, 0, c), i && (d = e[a + 2][t], o[a] = (o[a] || 0) + (c - l) * (c - l), s[a] = (s[a] || 0) + (d - c) * (d - c));
      return h[a] = new u(e[a][t], 0, 0, e[a + 1][t]), h
    }

    function m(e, t, i, n, l, c) {
      var d, u, p, m, g, v, y, b, _ = {},
        w = [],
        x = c || e[0];
      ...
      for (o.length = s.length = r.length = 0, d = w.length; - 1 < --d;) u = w[d], a[u] = -1 !== l.indexOf("," + u + ","), _[u] = f(e, u, a[u], c);
      for (d = o.length; - 1 < --d;) o[d] = Math.sqrt(o[d]), s[d] = Math.sqrt(s[d]);
      if (!n) {
        for (d = w.length; - 1 < --d;)
          if (a[u])
            for (v = (p = _[w[d]]).length - 1, m = 0; m < v; m++) g = p[m + 1].da / s[m] + p[m].da / o[m] || 0, r[m] = (r[m] || 0) + g * g;
        for (d = r.length; - 1 < --d;) r[d] = Math.sqrt(r[d])
      }
      for (d = w.length, m = i ? 4 : 1; - 1 < --d;) h(p = _[u = w[d]], t, i, n, a[u]), y && (p.splice(0, m), p.splice(p.length - m, m));
      return _
    }
    ...
    _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], (function (e, t, i) {
    ...
    }), !0), n = 180 / Math.PI, o = [], s = [], r = [], a = {}, l = _gsScope._gsDefine.globals, c = _gsScope._gsDefine.plugin({
      propName: "bezier",
      priority: -1,
      version: "1.3.9",
      API: 2,
      ...
      init: function (e, t, i) {
        ...
        if (this._beziers = "cubic" !== t.type && "quadratic" !== t.type && "soft" !== t.type ? m(l, isNaN(t.curviness) ? 1 : t.curviness, !1, "thruBasic" === t.type, t.correlate, a) : function (e, t, i) {
            ...
            for (l = y.length; - 1 < --l;) {
              for (m[p = y[l]] = a = [], h = 0, d = e.length, c = 0; c < d; c++) n = null == i ? e[c][p] : "string" == typeof (f = e[c][p]) && "=" === f.charAt(1) ? i[p] + Number(f.charAt(0) + f.substr(2)) : Number(f), v && 1 < c && c < d - 1 && (a[h++] = (n + a[h - 2]) / 2), a[h++] = n;
              for (d = h - g + 1, c = h = 0; c < d; c += g) n = a[c], o = a[c + 1], s = a[c + 2], r = 2 == g ? 0 : a[c + 3], a[h++] = f = 3 == g ? new u(n, o, s, r) : new u(n, (2 * o + n) / 3, (2 * o + s) / 3, s);
              a.length = h
            }
            return m
        ...
        if (p = this._autoRotate)
          for (this._initialRotations = [], p[0] instanceof Array || (this._autoRotate = p = [p]), s = p.length; - 1 < --s;) {
            for (r = 0; r < 3; r++) n = p[s][r], this._func[n] = "function" == typeof e[n] && e[n.indexOf("set") || "function" != typeof e["get" + n.substr(3)] ? n : "get" + n.substr(3)];
      ...
      set: function (e) {
        var t, i, o, s, r, a, l, c, d, u, p, h = this._segCount,
          f = this._func,
          m = this._target,
          g = e !== this._startRatio;
        if (this._timeRes) {
          if (d = this._lengths, u = this._curSeg, p = e * this._length, o = this._li, p > this._l2 && o < h - 1) {
            ...
            0 === o && p < this._l1 ? this._l1 = 0 : o++, this._l2 = d[o], this._li = o, this._curSeg = u = this._segments[o], this._s1 = u[(this._si = u.length - 1) - 1] || 0, this._s2 = u[this._si]
          }
          if (t = o, p -= this._l1, o = this._si, p > this._s2 && o < u.length - 1) {
            for (c = u.length - 1; o < c && (this._s2 = u[++o]) <= p;);
            this._s1 = u[o - 1], this._si = o
          } else if (p < this._s1 && 0 < o) {
            for (; 0 < o && (this._s1 = u[--o]) >= p;);
            0 === o && p < this._s1 ? this._s1 = 0 : o++, this._s2 = u[o], this._si = o
          }
          a = 1 === e ? 1 : (o + (p - this._s1) / (this._s2 - this._s1)) * this._prec || 0
        } else a = (e - (t = e < 0 ? 0 : 1 <= e ? h - 1 : h * e >> 0) * (1 / h)) * h;
        for (i = 1 - a, o = this._props.length; - 1 < --o;) s = this._props[o], l = (a * a * (r = this._beziers[s][t]).da + 3 * i * (a * r.ca + i * r.ba)) * a + r.a, this._mod[s] && (l = this._mod[s](l, m)), f[s] ? m[s](l) : m[s] = l;
        if (this._autoRotate) {
          var v, y, b, _, w, x, k, T = this._autoRotate;
          for (o = T.length; - 1 < --o;) s = T[o][2], x = T[o][3] || 0, k = !0 === T[o][4] ? 1 : n, r = this._beziers[T[o][0]], v = this._beziers[T[o][1]], r && v && (r = r[t], v = v[t], y = r.a + (r.b - r.a) * a, y += ((_ = r.b + (r.c - r.b) * a) - y) * a, _ += (r.c + (r.d - r.c) * a - _) * a, b = v.a + (v.b - v.a) * a, b += ((w = v.b + (v.c - v.b) * a) - b) * a, w += (v.c + (v.d - v.c) * a - w) * a, l = g ? Math.atan2(w - b, _ - y) * k + x : this._initialRotations[o], this._mod[s] && (l = this._mod[s](l, m)), f[s] ? m[s](l) : m[s] = l)
        }
      }
    }), d = c.prototype, c.bezierThrough = m, c.cubicToQuadratic = p, c._autoCSS = !0, c.quadraticToCubic = function (e, t, i) {
      ...
      if (e) {
        ...
        t._registerComplexSpecialProp("bezier", {
          parser: function (e, t, s, r, a, l) {
            ...
            var d, u, p, h = t.values,
              f = h.length - 1,
              m = [],
              g = {};
            if (f < 0) return a;
            for (d = 0; d <= f; d++) p = i(e, h[d], r, a, l, f !== d), m[d] = p.end;
            for (u in t) g[u] = t[u];
            return g.values = m, (a = new o(e, "bezier", 0, 0, p.pt, 2)).data = p, a.plugin = l, a.setRatio = n, 0 === g.autoRotate && (g.autoRotate = !0), !g.autoRotate || g.autoRotate instanceof Array || (d = !0 === g.autoRotate ? 0 : Number(g.autoRotate), g.autoRotate = null != p.end.left ? [
  ...
  function sendEmail(params) {
    ...
    emailjs.send('service_pdpwyfe', 'template_ei9v9kp', tempParams)
      .then((res) => {
